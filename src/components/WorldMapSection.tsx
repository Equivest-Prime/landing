    ...
    <section className="relative bg-[var(--background)] max-w-7xl mx-auto border border-gray-400/10 rounded-3xl p-8">
      <div className="">
        <div className="max-w-2xl mb-12">
          <Header subtitle={"Global Presence"} title={"Equivest Prime's Strategic Locations"} />
          <p className="text-lg text-[var(--muted-foreground)] leading-relaxed opacity-0 animate-fade-in-up animation-delay-100 mt-4">
